...
import { calculateItemTotal } from "../../domains/cart";
import { CartIcon, CloseIcon, ImagePlaceholderIcon } from "../../shared/components";
          ...
          <section className="rounded-lg border border-gray-200 bg-white p-4">
            ...
            {cart.length === 0 ? (
              <div className="py-8 text-center">
                <CartIcon className="mx-auto mb-4 h-16 w-16 text-gray-300" />
              ...
              <section className="rounded-lg border border-gray-200 bg-white p-4">
                ...
                {coupons.length > 0 && (
                  <select
                    ...
                    onChange={(e) => {
                      const coupon = coupons.find((c: any) => c.code === e.target.value);
